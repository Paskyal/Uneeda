tableextension 50069 "NV8 Bin Content" extends "Bin Content" //7302
{
    fields
    {
        field(50000; "NV8 Item Description"; Text[50])
        {
        ...
        field(50002; "NV8 Last Direct Cost"; Decimal)
        {
            CalcFormula = sum(Item."Last Direct Cost" where("No." = field("Item No.")));
            DecimalPlaces = 0 : 5;
            Description = 'UE-650';
            FieldClass = FlowField;
        }
